...
d3.csv("data,csv", function(error,healthData){
    ...
    var yScale = d3.scaleLinear().domain(0,d3.extent(data, function(d){ return d.healthcareLow;})).range([chartHeight, 0]);
    var xScale = d3.scaleLinear().domain(d3.extent(data, function(d){ return d.poverty;})).range([0,chartWidth]);
